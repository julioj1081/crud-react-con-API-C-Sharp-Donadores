...
namespace WebAPI.Controllers
{
    ...
    {
        private readonly DonationBDContext _context;

        public DCandidateController(DonationBDContext context)
        {
            _context = context;
        }

        // GET: api/DCandidate Devolvera todos los candidatos
        [HttpGet]
        ...
        // GET: api/DCandidate/5 Devulve un registro en especifico
        [HttpGet("{id}")]
        ...
        // POST: api/DCandidate Agrega un candidato nuevo
        // To protect from overposting attacks, enable the specific properties you want to bind to, for
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        ...
        // DELETE: api/DCandidate/5 Borra un candidato
        [HttpDelete("{id}")]
